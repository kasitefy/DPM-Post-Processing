...
MultiFilter::MultiFilter(
    QStringList &Label, std::vector<double> &Vmin, std::vector<double> &Vmax,
    std::map<QString, range> &MapRange, QWidget *parent
) :
    label(Label),
    vmin(Vmin),
    vmax(Vmax),
...
void MultiFilter::on_default_pushButton_clicked()
{
    initTable();
}
